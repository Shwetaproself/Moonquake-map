...
def fetch_2024():
    """
    Fetches Nakamura 2024 shallow moonquake locations file
    """
    url = "https://pds-geosciences.wustl.edu/lunar/urn-nasa-pds-apollo_seismic_event_catalog/data/" \
          "nakamura_2024_sm_locations.csv"

    file_path_out = os.path.join(os.getcwd(), "data", "nakamura", "nakamura_2024_sm_locations.csv")
...
def convert_1979():
    """
    Converts columns of Nakamura 2024 shallow moonquake locations file.
    ...
    file_path_in = os.path.join(os.getcwd(), "data", "nakamura", "nakamura_2024_sm_locations.csv")
    ...
    shallow_mq["label"] = "Nakamura (2024)"
